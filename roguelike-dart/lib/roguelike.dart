...
class Roguelike {
  ...
  static final int QUANTIDADE_LOBOS = 10;
  static final int QUANTIDADE_CARNEIROS = 10;
  static final int QUANTIDADE_MOEDAS = 20;
  static final int QUANTIDADE_GOLD = 0;
  static final int QUANTIDADE_VIDAS = 5;
  ...
  void criarMundo() {
    ...
    // Cria o jogador
    _jogador = Jogador(
        posicao, Jogador.SIMBOLO_JOGADOR, QUANTIDADE_VIDAS, QUANTIDADE_GOLD);
  ...
  void executar() {
    ...
    // Gameover
    print("\nVocê perdeu após ${_jogador.passos} passos!");
  }
}
