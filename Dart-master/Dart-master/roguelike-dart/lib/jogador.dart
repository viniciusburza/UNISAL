...
class Jogador extends Personagem {
  ...
  static final String SIMBOLO_JOGADOR = "P";

  int _vidas; // Variável privada (_nomeDaVariavel)
  int _moedas; // Variável privada (_nomeDaVariavel)
  ...
  Jogador(Ponto2D posicao, String simbolo, this._vidas, this._moedas)
